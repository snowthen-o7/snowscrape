...
def fetch_and_parse_page(url: str, timeout: int = 15, min_tier: int = 1, max_tier: int = 4) -> Dict[str, Any]:
    """
...
def test_extraction(url: str, selectors: List[Dict[str, str]], timeout: int = 15, min_tier: int = 1, max_tier: int = 4) -> List[Dict[str, Any]]:
    """
